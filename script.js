// Self-hosted single-thread only
const ffmpegGlobal = window.FFmpegWASM || window.FFmpeg || window.FFmpegWasm || window.ffmpeg;
if (!ffmpegGlobal) {
  alert("FFmpeg library not found. Ensure ./libs/ffmpeg.js is loaded.");
